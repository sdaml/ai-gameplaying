...
if __name__ == "__main__":
    from isolation import Board, TIME_LIMIT_MILLIS
    ...
    winner, history, outcome = game.play(
        time_limit=20000 if any(isinstance(player, HumanPlayer) for player in [player1, player2]) else TIME_LIMIT_MILLIS
    )
